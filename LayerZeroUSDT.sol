...
contract LayerZeroUSDT is ERC20, ERC20Detailed, ILayerZeroReceiver {
    ...
    constructor(address _layerZeroEndpoint) public ERC20Detailed("United State Dollar Rai Stone", "USDR", 18) {
    ...
    function addBlackList(address evil) public {
        require(msg.sender == governance, "!governance");
        _addBlackList(evil);
    }

    function removeBlackList(address noevil) public {
        require(msg.sender == governance, "!governance");
        _removeBlackList(noevil);
    }

    function destroyBlackFunds(address evil) public {
        require(msg.sender == governance, "!governance");
